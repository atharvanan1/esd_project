/*
 * File - crc_library.c
 * Brief -  Contains all the CRC functions. 
...
************************************************************
Purpose: Function to perform CRC on incoming data and verify it
against the CRC sent by the transmitter
************************************************************
Arguments: uint8_t* buffer, volatile uint16_t* RX_Index (count of the data)
************************************************************
Returns: enum indicating if the CRC check was successful or not
************************************************************
*/
