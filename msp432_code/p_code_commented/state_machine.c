...
// State in which the programmer performs CRC check and performs parsing of the hex code received
...
// State in which programmer is ready to interact with the target board
...
// State in which the programmer performs chip erase
...
// State in which the programmer sends programming enable command and writes to the flash memory
...
// State in which the programmer checks if the the flash memory was written to correctly
